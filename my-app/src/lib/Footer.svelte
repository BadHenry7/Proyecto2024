<div class="pt-5">
    <div
        class="rounded"
        style="background-color: deepskyblue; border-style: solid; border-color:darkcyan;"
    ><div class="container">
        <div class="row pt-5" style="margin-left: 10%;">
            ...
            <div
                class="col-lg-4 col-4 col-md-4 col-sm-4 col-xl-4 text-decoration-none"
            >
                <div
            ...
            >
                <div>WhatsApp: +XXXXXXXXXXXX</div>
                <div>Correo Electronico: XXXXXXXXXX</div>
                <div>Telefono: XXXXXXX</div>
                <div class="py-4">
                    <p>
                        <strong>HOSTIPAL®</strong> Todos los derechos reservados
                        2023
                    </p>
                </div>
            </div>
